...
public class EldoradoCoreModTabs {
	...
	public static final RegistryObject<CreativeModeTab> ELDORADO_CORE = REGISTRY.register("eldorado_core",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.eldorado_core.eldorado_core")).icon(() -> new ItemStack(EldoradoCoreModBlocks.ELDORADIUM_BLOCK.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(EldoradoCoreModBlocks.ELDORADO_SUN_WOOD_COMPRESSED.get().asItem());
				...
				tabData.accept(EldoradoCoreModBlocks.ELDORADO_SUN_WOOD_PLANK_STAIR.get().asItem());
				tabData.accept(EldoradoCoreModBlocks.ELDORADO_SUN_WOOD_BLEACHED_PLANK_STAIR.get().asItem());
				tabData.accept(EldoradoCoreModBlocks.ELDORADO_SUN_WOOD_COMPRESSED_STAIR.get().asItem());
				tabData.accept(EldoradoCoreModBlocks.ELDORADO_WOOD_PLANK_STAIR.get().asItem());
				tabData.accept(EldoradoCoreModBlocks.ELDORADO_WOOD_PLANK_COMPRESSED_STAIR.get().asItem());
